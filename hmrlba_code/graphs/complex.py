...
from hmrlba_code.feat.complex import (AtomProp, BondProp,
...
class Complex:
    ...
    def build(self, pdb_file: str, lig_smi: str, target: Union[float, np.ndarray],
        ...
        if 'build_prot' in kwargs and kwargs.get('build_prot'):
            ...
            if 'prot_model' in kwargs:
                prot_kwargs['prot_model'] = kwargs['prot_model']
            if 'prot_tokenizer' in kwargs:
                prot_kwargs['prot_tokenizer'] = kwargs['prot_tokenizer']
            if 'plm' in kwargs:
                prot_kwargs['plm'] = kwargs['plm']
