...
from hmrlba_code.data.base import ComplexData, HierData
...
class ComplexBatch(Data):
    ...
    def from_data_list(cls, 
        ...
        batch.protein2 = ProtBatch.from_data_list([getattr(data, 'protein2')
                                                for data in data_list], prot_mode=prot_mode)
        batch.protein3 = ProtBatch.from_data_list([getattr(data, 'protein3')
                                                for data in data_list], prot_mode=prot_mode)
